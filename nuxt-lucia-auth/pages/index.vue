<template>
  <section
    ...
    style="
      background: url(https://shuffle.dev/gradia-assets/images/hero/bg.png)
        no-repeat;
  ...
  >
          ...
          <div class="flex flex-wrap items-center">
            <div class="w-auto hidden lg:block">
              <ul class="flex items-center mr-10">
                <li
                  class="font-heading mr-9 text-white hover:text-gray-200 text-lg"
                >
                  <a href="#">Features</a>
                </li>
                <li
            ...
            <div class="w-auto hidden lg:block">
              <RouterLink
                to="/auth/signup"
                class="group relative font-heading block py-2 px-5 text-lg text-white border-2 border-white overflow-hidden rounded-10"
              >
                <div
    ...
    <div class="container mx-auto px-4">
      <div class="flex flex-wrap justify-between -m-6 pt-10">
        <div class="w-full lg:w-5/12 xl:w-1/2 p-6">
          ...
          <h1 class="mb-4 font-heading text-7xl text-white font-bold">
            Manage remote team, anywhere, anytime.
          </h1>
          <div class="flex flex-wrap -m-3 mb-3">
            <div class="w-full lg:w-auto p-3">
              <RouterLink
                to="/auth/signup"
                class="block font-heading w-full px-6 py-4 text-base text-gray-900 bg-white hover:bg-gray-100 rounded-md"
              >
            ...
            <div class="w-full lg:w-auto p-3">
              <button
                class="font-heading w-full px-6 py-4 text-base text-white bg-transparent border border-gray-500 hover:border-gray-600 rounded-md"
              >
                How it works
              </button>
            </div>
          ...
          <div class="lg:max-w-md">
            <div class="flex flex-wrap -m-3">
              <div class="w-auto p-3">
                <img
                  class="w-14 h-14"
                  src="https://shuffle.dev/gradia-assets/images/hero/avatar-man.png"
                  alt=""
                />
              </div>
          ...
          <div class="max-w-max mx-auto">
            <div class="flex flex-wrap justify-center -m-3 mb-3">
              <div class="w-full p-3">
                <div
                  class="mx-auto w-64 p-3 bg-white transform hover:-translate-y-3 transition ease-out duration-1000 rounded-2xl"
                >
              ...
              <div class="w-full sm:w-1/2 p-3">
                ...
                >
                  <div class="flex flex-wrap -m-2">
                    <div class="w-auto p-2">
                      <img
                        src="https://shuffle.dev/gradia-assets/images/hero/avatar-circle2.png"
                        alt=""
                      />
                    </div>
                    <div class="w-auto p-2">
              ...
              <div class="w-full sm:w-1/2 p-3">
                ...
                >
                  <div class="flex flex-wrap -m-2">
                    <div class="w-auto p-2">
                      <img
                        src="https://shuffle.dev/gradia-assets/images/hero/avatar-circle3.png"
                        alt=""
                      />
                    </div>
                    <div class="w-auto p-2">
            ...
            <div
              class="flex flex-wrap justify-center max-w-max -m-3 mb-3 xl:-ml-20"
            >
              <div class="w-full sm:w-1/2 p-3">
                <div
                  class="mx-auto w-64 p-3 bg-white transform hover:-translate-y-3 transition ease-out duration-1000 rounded-2xl"
                >
                  <div class="flex flex-wrap -m-2">
                    <div class="w-auto p-2">
                      <img
                        src="https://shuffle.dev/gradia-assets/images/hero/avatar-circle4.png"
                        alt=""
                      />
                    </div>
                    <div class="w-auto p-2">
              ...
              <div class="w-full sm:w-1/2 p-3">
                ...
                >
                  <div class="flex flex-wrap -m-2">
                    <div class="w-auto p-2">
                      <img
                        src="https://shuffle.dev/gradia-assets/images/hero/avatar-circle5.png"
                        alt=""
                      />
                    </div>
                    <div class="w-auto p-2">
